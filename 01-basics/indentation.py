...
def cisla(number):
  #Vypíše čísla od 1 do 10, když číslo bude rovno zadanému číslo tak vypíše, že je to tvé číslo
    for i in range(1, 10):
        if i > number:
            print(f'{i} je za tvym cislem.')
        elif i == number:
             print(f'{i} je tvoje cislo.')
        else:
            print(f'{i} je pred tvym cislem.')
# Vypíše docstring spojený s funkcí cisla
print(cisla.__doc__)
# Vyvolá funkci cisla s parametrem 5
cisla(5)