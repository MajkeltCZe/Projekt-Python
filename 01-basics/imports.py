...
time = datetime.now()
print("Aktuální datum a čas: %s." % time)
...
years = 5
now = parse("Mon Sep 26 20:08:46 UTC 2022")
today = now.date()
year = rrule(YEARLY,dtstart=now,bymonth=12,bymonthday=24,byweekday=SU)[0].year
print("Datumy Velikonoc v následujících %d letech:" % years)
for i in range(0, years):
   print(easter(year+i))
print("Nejbližší Vánoce v neděli budou v roce %s." % year)
